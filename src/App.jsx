...
const CATS = [
  ...
  {id:"logo",label:"Logo & Identity",code:"LI",icon:"◑"},
  {id:"random",label:"Randomise",code:"RD",icon:"⟳"},
];
const REAL_CATS = CATS.filter(c => c.id !== "random");

const APPENDIX_REFS = {
  corporate: `STYLE A — write per page: Cover headline "Visual Identity Guide [Month Year]" · Introduction: bold headline + 2 body paragraphs · Contents: 8 sections with page numbers · Logo page: headline + "The Rules" label · Colour headline · Typography headline · Iconography headline + 5 industry-specific icon labels · Photography headline · Application headline · Contact Us: full name, title, company, phone (+country code), email · Back cover: copyright line + full street address + website. Billboard: bold headline + short subheading. Vehicle wrap: one tagline.
STYLE B — Flyer front: venue name + 2–3 sentence description + hero dish/product + website URL. Flyer back: brand mission (2 sentences) + QR code CTA sentence + partner org description (2 sentences) + website + social handle.`,
  packaging: `Write two variants. Per variant — Package: product name + volume + variant descriptor + hero headline ("Craving X?" style) + 2–3 flavour/benefit sentences + 3 feature bullet points + 2 body paragraphs + full INCI ingredients list + manufacturer city + address + website + legal warning sentence + logos list (PAP, recycling symbol, period-after-opening). Brochure front: logos + product name + tagline + illustration note. Brochure inside: welcome para (2 sentences) + product specs table (variant, volume, formula, key features) + 2 body sections with headlines. Brochure back: brand tagline + social handles + hashtags + website + one CTA sentence.`,
  editorial: `Per spread — section label + heading + sub-heading + 80–150 word body paragraph (real sentences). Story pages: story title + 3–4 sentence narrative + hyperlink URL. Feature pages: bold feature name + 1–2 sentence technical description. Cover outside: product name + hero line + season/year + website. Cover inside: 5 brand values (short phrases) + HQ address + phone + website. Back cover: report/campaign name + 3–4 sentence body + read/download CTA + QR URL. Symbol names: 4 feature names matching inner pages.`,
  display: `Poster series: headline + 1–2 sentence supporting copy + event/venue + date + website. Exhibition booth: section labels (4–6 short labels) + navigation text + key brand message (1 sentence). Roll-up: headline + subheading + logo note + website.`,
  illustration: `Series title + concept description (2–3 sentences). Per piece: illustration title + 1–2 sentence brief/theme description. Any required text to incorporate into the artwork (quotes, labels, captions).`,
  advertising: `Key visual: headline + subheading. Banner/GIF (728×90px): short copy (max 8 words) + CTA. Banner/GIF (160×600px): headline (4 words) + CTA. Reel (1080×1920px): 3–5 caption lines or VO script. All copy must be campaign-consistent in tone.`,
  infographic: `Title + subtitle. 4–6 data points: statistic or fact + source attribution + short label. Section headers (3–4 words each). One pull quote (attributed).`,
  typography: `Feature headline (expressive, 3–6 words). Body paragraph (80–100 words, real sentences on a relevant theme). Pull quote (10–20 words, attributed). Optional: secondary word or phrase for typographic treatment.`,
  logo: `Brand name + tagline (6–10 words). Brand values: 3 single words. Brand personality: 2–3 descriptive adjectives. Industry/sector description (1 sentence). One usage example sentence (e.g. "The logo should work on X, Y and Z").`,
};

const PAPER_REFS = {
  corporate: `Modelled on WSC/Emirates Skills Corporate Design (Autege, Abu Dhabi 2026) and WSA Brisbane Nationals 2025 (HINTERPLATE, Queensland).
BRIEF: Tech/SaaS, service, or tourism/lifestyle brand with clear founding story, 2–3 founders or initiative leads, specific city/country. WHAT/WHY/HOW structure. Target audience by role, age range (22–55), digital familiarity, work/travel environment. 8–10 brand concept keywords (e.g. Efficiency, Discovery, Reliability, Innovation, Authenticity, Professional).
TASKS (pick one style): STYLE A — Logo (Spot 2–3 colours + CMYK + Black only, 145mm longest edge, no gradients, text to outlines, GRACoL 2006) + Visual Identity Guide 16pp InDesign (260×180mm, CMYK, 3mm bleed, 280ppi, interactive PDF, TOC, hyperlinks) — sections: Cover · Introduction · Contents · Logo Usage · Brand Colours (CMYK/RGB/HSB/HEX) · Typography · Iconography (5 icons + 2 patterns) · Photography · Application · Contact Us · Back Cover + Mockups (vehicle wrap + billboard, 260×180mm, Apple RGB, 280ppi). STYLE B — Logo (colour + mono, versatile) + Vehicle Wrap (tagline, social handles, QR code, partner logo) + A6 double-sided flyer (105×148mm, hotspot/venue feature per edition, 4mm bleed).
APPENDIX TEXT STYLE A: Cover headline "Visual Identity Guide" + month/year · Introduction headline + 2 body paragraphs · Contents list (8 sections with page numbers) · Logo page headline + rules label · Colour headline · Typography headline · Iconography headline + 5 specific icon labels relevant to industry · Photography headline · Application headline · Contact Us: full name, title, company, phone (+country code), email · Back cover: copyright + full street address + website URL. Billboard: bold headline + short subheading. Vehicle wrap: tagline only.
APPENDIX TEXT STYLE B: Flyer front — venue name + 2–3 sentence description + hero product/dish + website URL. Flyer back — brand mission statement (2 sentences) + QR code CTA + partner organisation description (2 sentences) + website + social handle.`,
  packaging: `Modelled on WSC2019 TP40 (dates/food, bilingual) and Emirates Skills TP40_C3 (Hismile x Poppi, Australia 2026).
BRIEF: Consumer product brand — could be food & beverage, oral care, wellness, beauty, or lifestyle. Can be a collaboration between two brands. WHAT/WHY/HOW structure. Target audience by age (16–40), lifestyle, digital behaviour, design-consciousness. 8–10 brand concept keywords (e.g. Playful, Bold, Fresh, Innovative, Flavour-Driven, Vibrant, Approachable).
TASKS: Wordmark or logo (Spot 1–2 colours + CMYK + Black only, 85mm longest edge, no gradients, text to outlines, GRACoL 2006) + Dieline package design in Illustrator/InDesign (A3 max, CMYK + Varnish spot + Cut/Fold/Glue spot layers, ISO Coated v2 300%, 3mm bleed, 255ppi) — must hold products securely, hanging hook mechanism, two-layer hole area, open/close top — two variants on separate artboards + Double-sided folded brochure InDesign (297×210mm max, Black + 1 Spot, FOGRA29 Uncoated, 3mm bleed, 250ppi).
APPENDIX TEXT PACKAGE (write two variants): Product name + volume/weight + flavour/variant descriptor + hero headline + 2–3 sentence flavour description + 3 key product features (bullet style) + 2-paragraph brand/product body copy + ingredients list (full INCI format) + manufacturing info + address + website + legal warning text + regulatory logos list (PAP, recycling, period-after-opening). APPENDIX TEXT BROCHURE (front/inside/back per variant): Front — wordmark + partner logo + product name + tagline + hero illustration note. Inside — welcome paragraph + product specs table + 2 body sections with headlines + conscious design statement. Back — brand tagline + social handles + hashtags + website + CTA line.`,
  editorial: `Modelled on WSC2022 UN Ocean Conference, WSC2024 AI & Creativity, and Emirates Skills TP40_C2 (Patagonia Capilene Cool Sun, 2026).
BRIEF: Booklet or publication for an outdoor/lifestyle/tech/NGO brand. Specific product line or campaign as the subject. Target audience by activity type, age (20–50), eco-consciousness or lifestyle. WHAT/WHY/HOW structure.
TASKS: Cover InDesign (160×240mm, CMYK + 1 Spot dieline, 4mm bleed, 250ppi, Coated Fogra39) — front cover outside with image composition (3+ images), die-cut flap, back cover with QR code + Inner pages InDesign (160×240mm, 24pp, CMYK, 3mm bleed top/bottom/outside only, 240ppi, Fogra39) — paragraph styles: Heading / Sub-Heading / Body — master pages with page number + brand name + section label + recurrent element — auto Table of Contents — pages 10–17 two spot colours + black only — hyperlinks on story headlines + Coordinated symbol series Illustrator (4 symbols, monochromatic spot colour, displayed at 2cm and 10cm).
APPENDIX TEXT: Per page/spread — Running headline (section label) · Heading · Sub-Heading · Body copy (2–4 paragraphs of real sentences per spread, 80–150 words each) · Story sections: story title + 3–4 sentence narrative + hyperlink URL · Feature pages: bold feature name + 1–2 sentence technical description · Cover outside: logo note + image composition note + product name + hero line + season/year + website · Cover inside: brand values list (5 items) + HQ address + phone + website · Back cover outside: report/campaign name + 3–4 sentence body + CTA + QR code URL · Symbol labels: 4 specific feature names matching inner page content.`,
